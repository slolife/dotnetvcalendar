...
namespace VCalendar
{
    ...
    public class EventInformation
    {
        ...
        public AlarmCollection Alarms => new AlarmCollection();
        ...
        /// <summary>
        /// Gets or sets the sequence number, which corresponds to the number of revisions this event has had.
        /// </summary>
        public int Sequence { get; set; }

        /// <summary>Gets or sets the whether the event is transparent to free time searches.</summary>
        /// <remarks>
        /// The standards state that a value of 0 is busy, 1 is free and greater than 1 is to be determined
        /// by the application.
        ...
        public override string ToString()
        {
            ...
            result.AppendFormat("CLASS:{0}", IsPrivate ? "PRIVATE" : "PUBLIC").AppendLine();
